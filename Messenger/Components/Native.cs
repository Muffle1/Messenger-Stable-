...
namespace Messenger
{
    public static class Native
    {
        ...
        public static void WmGetMinMaxInfo(IntPtr hwnd, IntPtr lParam, int minWidth, int minHeight, Taskbar taskbar)
        {
            ...
            if (monitor != IntPtr.Zero)
            {
                ...
                if ((taskbar.Position == TaskbarPosition.Bottom) && (taskbar.AutoHide))
